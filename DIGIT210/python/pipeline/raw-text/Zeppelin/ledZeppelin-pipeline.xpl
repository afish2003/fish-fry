...
<p:declare-step xmlns:p="http://www.w3.org/ns/xproc" exclude-inline-prefixes="#all"
    ...
    <p:directory-list name="sourceColl" path="ledZeppelin"
    ...
    <p:for-each>
        ...
        <p:load href="ledZeppelin/{//c:file/@name}"/>
        ...
        <p:store name="simple-XML" href="../../ixml-output/Zeppelin/ledZeppelin/{$filename}.xml"/>
        ...
        <!-- ================================================================ -->
        <p:store name="full-xml-out" href="../../full-xml-output/Zeppelin/ledZeppelin/{$filename}.xml" serialization="map {
            'method' : 'xml',
            'indent' : true(),
