...
<p:declare-step xmlns:p="http://www.w3.org/ns/xproc" exclude-inline-prefixes="#all"
    ...
    <p:directory-list name="sourceColl" path="ledZeppelinII"
    ...
    <p:for-each>
        ...
        <p:load href="ledZeppelinII/{//c:file/@name}"/>
        ...
        <p:store name="simple-XML" href="../../ixml-output/Zeppelin/ledZeppelinII/{$filename}.xml"/>
        ...
        <!-- ================================================================ -->
        <p:store name="full-xml-out" href="../../full-xml-output/Zeppelin/ledZeppelinII/{$filename}.xml" serialization="map {
            'method' : 'xml',
            'indent' : true(),
        ...
        <p:store name="chord-progressions-out" href="../../chord-progressions-output/Zeppelin/ledZeppelinII/{$filename}.txt" />
