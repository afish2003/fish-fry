...
<p:declare-step xmlns:p="http://www.w3.org/ns/xproc" exclude-inline-prefixes="#all"
    ...
    <p:directory-list name="sourceColl" path="starcatcher"
    ...
    <p:for-each>
        ...
        <p:load href="starcatcher/{//c:file/@name}"/>
        ...
        <p:store name="simple-XML" href="../../ixml-output/Greta/starcatcher/{$filename}.xml"/>
        ...
        <!-- ================================================================ -->
        <p:store name="full-xml-out" href="../../full-xml-output/Greta/starcatcher/{$filename}.xml" serialization="map {
            'method' : 'xml',
            'indent' : true(),
        ...
        <p:store name="chord-progressions-out" href="../../chord-progressions-output/Greta/starcatcher/{$filename}.txt" />
