...
<p:declare-step xmlns:p="http://www.w3.org/ns/xproc" exclude-inline-prefixes="#all"
    ...
    <p:directory-list name="sourceColl" path="anthemOfThePeacefulArmy"
    ...
    <p:for-each>
        ...
        <p:load href="anthemOfThePeacefulArmy/{//c:file/@name}"/>
        ...
        <p:store name="simple-XML" href="../../ixml-output/Greta/anthemOfThePeacefulArmy/{$filename}.xml"/>
        ...
        <!-- ================================================================ -->
        <p:store name="full-xml-out" href="../../full-xml-output/Greta/anthemOfThePeacefulArmy/{$filename}.xml" serialization="map {
            'method' : 'xml',
            'indent' : true(),
        ...
        <p:store name="plain-lyrics-out" href="../../plain-lyrics-output/Greta/anthemOfThePeacefulArmy/{$filename}.txt" />
        ...
        <p:store name="chord-progressions-out" href="../../chord-progressions-output/Greta/anthemOfThePeacefulArmy/{$filename}.txt" />
